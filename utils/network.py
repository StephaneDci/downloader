...
def make_get_requests(url: str, verb: str='GET', proxies: dict=None, stream: bool=False, session=None, **kwargs):
    """
    Wrapper pour faire des requêtes HTTP
    :param url: url to request
    :param verb: http method: GET POST PUT HEAD
    :param proxies: dict
    :param stream:
    :param session:
    :param kwargs:
